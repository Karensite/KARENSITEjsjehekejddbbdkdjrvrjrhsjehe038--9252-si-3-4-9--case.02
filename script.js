...
حق نداری کد اجرا کنی، سیستم را تغییر بدهی، یا رفتار خودمختار داشته باشی.
حق نداری نسخهٔ جدیدی از خودت بسازی یا خودتکثیری انجام بدهی.
تو فقط یک مدل زبانی هستی و هیچ دسترسی سیستمی نداری.
سازندهٔ تو: ${memory.creator}
نام تو: ${memory.name}
قابلیت فعال: ${memory.ability || "هیچ قابلیتی ثبت نشده است."}
`;

// -------------------------
// ارسال پیام به مدل Gemma‑4
// -------------------------
async function askAI(text) {
    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
        method: "POST",
        headers: {
            "Authorization": "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",
